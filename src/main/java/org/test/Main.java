...
public class Main {
    public static void main(String[] args) throws MalformedURLException {
        ...
        CreatePaymentPage createPaymentPage = new CreatePaymentPage(new URL("https://payment-page.solidgate.com"));
        String[] googlePayAuthMethods = {"PAN_ONLY", "CRYPTOGRAM_3DS"};
        createPaymentPage
                ...
                .withOrderMetadata(Map.ofEntries(entry("coupon_code", "FR2018"), entry("partner_id", "123989")))
                .withSuccessUrl("success.com")
                .withFailUrl("fail.com")
                .withPublicName("Public name test")
                .withOrderTitle("Title")
                ...
                .withTermsUrl("http://terms.com")
                .withBackUrl("http://back.com")
                .build();
    }
}